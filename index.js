...
const UUID = process.env.UUID || 'f1c65b89-8e7b-4dba-b954-9d41f88e96ab'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'remove';            // 获取节点的订阅路径
const NAME = process.env.NAME || 'Web';                    // 节点名称
